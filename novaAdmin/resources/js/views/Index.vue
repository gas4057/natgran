...
export default {
  ...
  methods: {
    ...
    /**
     * Reset the monument by to its default state
     */
    resetOrderBy(field) {
      this.updateQueryString({
        [this.orderByParameter]: field.sortableUriKey,
    ...
    /**
     * Sync the current monument by values from the query string.
     */
  ...
  computed: {
    ...
    /**
     * Get the name of the monument by query string variable.
     */
    orderByParameter() {
    ...
    /**
     * Get the name of the monument by direction query string variable.
     */
    ...
    /**
     * Get the current monument by value from the query string.
     */
    currentOrderBy() {
    ...
    /**
     * Get the current monument by direction from the query string.
     */
