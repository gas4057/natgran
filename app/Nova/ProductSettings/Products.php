...
class Products extends Resource
{
    ...
    public static $search = [
        'id', 'name', 'info', 'description', 'specifications'
    ];
    ...
    public function fields(Request $request)
    {
        return [
            ...
            BelongsTo::make('Материал', 'material', 'App\Nova\ProductSettings\ProductMaterials')
                ->nullable(),
            HasMany::make('Модель стеллы', 'modelObjectStella', 'App\Nova\ProductSettings\ProductObjectModelStella')
                ->nullable(),
...
//                ->rules('required')
                ->path('Products')
                ->hideFromIndex(),
            HasMany::make('Изображения для модели','sarcophagusImages','App\Nova\ProductSettings\ProductImageForModel'),
        ];
    }
