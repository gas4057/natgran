@if($moreMaterial)
<div style="display: none;" id="more-material" class="more-material--wrap mCustomScrollbar" data-mcs-theme="3d-dark">
    <div class="more-material--content d-flex col">
        <h3 class="more-material--title">{{$moreMaterial->key}}</h3>

        <ul class="more-material__lists">
            <li class="more-material__list">
            @foreach($moreMaterial->block as $block)
