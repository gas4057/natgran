...
<div style="display: none;" id="more-stella_image-right" class="more-material--wrap modal--material more-material--wrap--beautification mCustomScrollbar" data-mcs-theme="3d-dark">
    <div class="more-material--content d-flex col">
        <h3 class="more-material--title">Все кресты</h3>

        <div class="stella_image__params product--body__row stella_image-img-right image__size flex-wrap d-flex ai-center mb-18 px-5">
            ...
            <label class="product--row__label product--row__50 product--row__label--material product--row__label--h200 image__size-item d-flex ai-center justify-center px-5
                            stella_image-img-right-select-item stella_image-img-right-select-{{$key}}" for="">
                <div class="stella_image__size-link stele__size-link image__size-link stele__size-link--img-big stele__size-link--img stele__size-link--big-circle aviable" id="material-1" data-position="right" data-element="stella_image" data-description="Тестовое описание из модального окна - 1" data-price="100">
