@if($moreText)
<div style="display: none;" id="more-text" class="more-material--wrap mCustomScrollbar" data-mcs-theme="3d-dark">
    <div class="more-material--content d-flex col">
        <h3 class="more-material--title">{{$moreText->key}}</h3>

        <ul class="more-material__lists">
            <li class="more-material__list">
                @foreach($moreText->block as $block)
