<div class="tabs-content">
    ...
    <div class="initials__params ajax__params mt-10">
        ...
        <div class="panel">
            <div class="product--body__row flex-wrap d-flex ai-center">
                <div class="product--row__name  product--row__name--full">Данные усопшего ”слева”:</div>
            ...
            <div class="product--body__row flex-wrap d-flex ai-center">
                <div class="product--row__name  product--row__name--full">Данные усопшего ”справа”:</div>

                <div class="product--label__row product--label__row--name">

                    <label class="product--label-text-input" for="">
                        <span class="">Введите фамилию</span>
                        <input class="initials-input product--text-input" type="text" data-element="initials" name="surname_right" id="surname_right" autocomplete="off">
                    </label>

                    <label class="product--label-text-input" for="">
                        <span class="">Введите имя</span>
                        <input class="initials-input product--text-input" type="text" data-element="initials" name="name_right" id="name_right" autocomplete="off">
                    </label>

                    <label class="product--label-text-input" for="">
                        <span class="">Введите отчество</span>
                        <input class="initials-input product--text-input" type="text" data-element="initials" name="patronymic_right" id="patronymic_right" autocomplete="off">
                    </label>
    ...
    <div class="date__params ajax__params mt-10">
        ...
        <div class="panel">
            ...
            <div class="product--body__row flex-wrap d-flex ai-center">
                <div class="product--row__name  product--row__name--full">
                    Памятные даты “справа”
                    <span class="product--stella-name product--stella-name--left">
                        (<span class="surname_right">Фамилия</span>
                        <span class="name_right">Имя</span>
                        <span class="patronymic_right">Отчество</span>)
                    </span>
                    <span class="colon">:</span>
                </div>
                ...
                <div class="product--label__row justify-start flex-wrap">
                <label class="product--label-text-input product--label-text-input--flex flex-wrap flex-0-0-a" for="">
                        <span class="product--span-date mr-10">Дата рождения:</span>
                        <input id="right_date_of_birth"
                            type='datable'
                            data-datable-divider="."
                            data-datable="ddmmyyyy"
                            data-element="date"
                            class='product--text-input date-input datepicker-here input-date-requared'
                            name="right_date_of_birth"
                            placeholder="ДД.ММ.ГГГГ"
                            autocomplete="off"/>
                    </label>

                    <label class="product--label-text-input product--label-text-input--flex flex-wrap flex-0-0-a" for="">
                        <span class="product--span-date mr-10">Дата смерти:</span>
                        <input id="right_date_of_die"
                            type='datable'
                            data-datable-divider="."
                            data-datable="ddmmyyyy"
                            data-element="date"
                            class='product--text-input date-input datepicker-here input-date-requared'
                            name="right_date_of_die"
                            placeholder="ДД.ММ.ГГГГ"
                            autocomplete="off"/>
                    </label>
                </div>
    ...
    <div class="epitaph__params ajax__params mt-10">
        ...
        <div class="panel">
            ...
            <div class="product--body__row flex-wrap d-flex ai-center">
                ...
                <label class="product--label-text-input" for="">
                    <span class="">Введите текст</span>
                    <textarea id="right_epitaph" name="right_epitaph" class="product--text-input product--text-input--textarea epitaph-input" data-element="epitaph"></textarea>
                </label>
            </div>
    ...
    <div class="stella_image__params ajax__params mt-10">
        <div id="accordion-stella-drawing" class="accordion accordion--no-img">
            ...
            <div id="stella_image__name" class="accordion__title">
                ...
                <p class="header--info__params">
                    стоимость одного крестика лево
                    <span class="left-price">0</span>
                    руб.
                </p>
                <p class="header--info__params">
                    стоимость одного крестика право
                    <span class="right-price">0</span>
                    руб.
                </p>
            </div>
        </div>
        <div class="panel panel--px-0">
            ...
            <div class="product--body__row stella_image-color-left flex-wrap d-flex ai-center mb-18 px-5">
                <div class="product--row__name  product--row__name--full">
                    Цвет:
                    <a class="product__link" href="#" data-fancybox data-src="#more-text">Подробнее</a>
                </div>
            ...
            <div class="product--body__row flex-wrap d-flex ai-center mb-18 px-5">
                <div class="product--row__name  product--row__name--full">
                    Рисунок на стелу “справа”
                    <span class="product--stella-name product--stella-name--right">
                        (<span class="surname_right">Фамилия</span>
                        <span class="name_right">Имя</span>
                        <span class="patronymic_right">Отчество</span>)
                    </span>
                ...
                @if($imgTypesStella)
                <label class="product--row__label product--row__label--50 stele__size-link--link product--row__label--link stele__size-item d-flex ai-center justify-center p-relative px-0" for="">
                    <select class="stele__size-select aviable" name="stella_image-img-right-select" id="stella_image-img-right-select">
                        <option value="stella_image-img-right-select-item">Все кресты</option>
                        @foreach($imgTypesStella as $type)
                        <option value="stella_image-img-right-select-{{$type->slug}}">{{$type->type}}</option>
                        @endforeach
                    </select>
                </label>
                    @endif
            ...
            @if($arStellaImages)
            <div class="modal--material product--body__row stella_image-img-right image__size flex-wrap d-flex ai-center mb-18 px-5">
                @foreach($arStellaImages as $key=>$stellaImages)
                    @foreach($stellaImages as $stellaImage)
                        @if($loop->iteration <7)
                ...
                <div class="col-100 px-5">
                    <a class="product__link product__link--big" href="#" data-fancybox data-src="#more-stella_image-right">Показать еще кресты</a>
                </div>
            </div>
            @endif
            <div class="product--body__row stella_image-color-right flex-wrap d-flex ai-center mb-18 px-5">
                <div class="product--row__name  product--row__name--full">
                    Цвет:
                    <a class="product__link" href="#" data-fancybox data-src="#more-text">Подробнее</a>
                </div>
                ...
                <div class="product--row__params product--row__params-100 color__size d-flex ai-center" data-dimension="stella_image_form">
                    @foreach($colorsForText as $item)
                        @if($loop->iteration <3)
                        <label class="product--row__label product--row__label--50 color__size-item d-flex ai-center justify-center" for="">
                            <div class="color__size-link aviable" id="stella_image_form-{{$item->id}}" data-position="right" data-price="{{$item->price}}" data-element="stella_image">
                                <input class="hide-input par--js" type="radio" name="right_stella_color_id" value="{{$item->id}}">
                                <p class="d-flex ai-center justify-center">{{$item->color}}</p>
                            </div>
                        </label>
                        @endif
    ...
    <div class="tombstone_image__params ajax__params mt-10">
        <div id="accordion-tombstone-drawing" class="accordion accordion--no-img">
            ...
            <div id="tombstone_image__name" class="accordion__title">
                ...
                <p class="header--info__params">
                    стоимость одного рисунка лево
                    <span class="left-price">0</span>
                    руб.
                </p>
                <p class="header--info__params">
                    стоимость одного рисунка право
                    <span class="right-price">0</span>
                    руб.
                </p>
            </div>
        ...
        <div class="panel panel--px-0">
            ...
            <div class="product--body__row flex-wrap d-flex ai-center mb-18 px-5">
                <div class="product--row__name  product--row__name--full">
                    Выберите рисунок на надгробную плиту “слева”
                    <span class="product--stella-name product--stella-name--left">
                        (<span class="surname_left">Фамилия</span>
                        <span class="name_left">Имя</span>
                        <span class="patronymic_left">Отчество</span>)
            ...
            @endif
            <div class="product--body__row tombstone_image-color-left flex-wrap d-flex ai-center mb-18 px-5">
                <div class="product--row__name  product--row__name--full">Цвет:</div>
            ...
            <div class="product--body__row flex-wrap d-flex ai-center mb-18 px-5">
                <div class="product--row__name  product--row__name--full">
                    Выберите рисунок на надгробную плиту “справа”
                    <span class="product--stella-name product--stella-name--right">
                        (<span class="surname_right">Фамилия</span>
                        <span class="name_right">Имя</span>
                        <span class="patronymic_right">Отчество</span>)
                ...
                @if($imgTypesTombstone)
                <label class="product--row__label product--row__label--50 stele__size-link--link product--row__label--link stele__size-item d-flex ai-center justify-center p-relative px-0" for="">
                    <select class="stele__size-select aviable" name="tombstones_image-img-right-select" id="tombstones_image-img-right-select">
                        <option value="tombstones_image-img-right-select-item">Все рисунки</option>
                        @foreach($imgTypesTombstone as $type)
                        <option value="tombstones_image-img-right-select-{{$type->slug}}">{{$type->type}}</option>
                        @endforeach
                    </select>
                </label>
                    @endif
            ...
            @if($tombstoneImages)
            <div class="modal--material product--body__row tombstone_image-img-right image__size flex-wrap d-flex ai-center mb-18 px-5">
                @foreach($arTombstoneImages as $key=>$tombstoneImages)
                    @foreach($tombstoneImages as $tombstoneImage)
                        @if($loop->iteration <7)
                ...
                @endforeach
                <div class="col-100 px-5">
                    <a class="product__link product__link--big" href="#" data-fancybox data-src="#more-tombstone_image-right">Показать еще рисунки</a>
                </div>
            </div>
            @endif
            <div class="product--body__row tombstone_image-color-right flex-wrap d-flex ai-center mb-18 px-5">
                <div class="product--row__name  product--row__name--full">
                    Цвет:
                    <a class="product__link" href="#" data-fancybox data-src="#more-text">Подробнее</a>
                </div>
                ...
                <div class="product--row__params product--row__params-100 color__size d-flex ai-center" data-dimension="tombstone_image_form">
                    @foreach($colorsForText as $item)
                        @if($loop->iteration <3)
                            <label class="product--row__label product--row__label--50 color__size-item d-flex ai-center justify-center" for="">
                                <div class="color__size-link aviable" id="tombstone_image_form-{{$item->id}}" data-position="right" data-price="{{$item->price}}" data-element="tombstone_image">
                                    <input class="hide-input par--js" type="radio" name="right_tombstone_color_id" value="{{$item->id}}">
                                    <p class="d-flex ai-center justify-center">{{$item->color}}</p>
                                </div>
                            </label>
                        @endif
